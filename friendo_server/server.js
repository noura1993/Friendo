...
app.post("/users/create", (req, res) => {
  ...
  [req.body.firstName, req.body.lastName, req.body.email, 
    req.body.password, req.body.interest, req.body.gender, req.body.age, "https://api.adorable.io/avatars/128/" + req.body.firstName + ".png", 55.9440817, -3.1705872, "Arthur's Seat", ""],
    (err, sqlRes) => {
      if (err) {
        console.log(err)
        res.json({ error: err });
